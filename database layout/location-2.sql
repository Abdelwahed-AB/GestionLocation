...
(9, 'abd', 'ab', 'agadr', 212, 'C:\\Users\\Abd-AB\\Documents\\Wallpapers\\ds.jpg', 'C:\\Users\\Abd-AB\\Documents\\Wallpapers\\ds.jpg'),
(10, 'danger', 'danger', 'agad', 212, 'C:\\Users\\Abd-AB\\Documents\\Wallpapers\\ds.jpg', 'C:\\Users\\Abd-AB\\Documents\\Wallpapers\\ror2.jpg');
...
CREATE TABLE `parking` (
  `codeParking` int(30) NOT NULL,
  `nomParking` varchar(75) NOT NULL,
  `capaciteParking` varchar(30) NOT NULL,
  `rueParking` varchar(100) NOT NULL,
  `arrondissement` varchar(100) NOT NULL,
  `nombrePlaceVide` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `parking` (`codeParking`, `nomParking`, `capaciteParking`, `rueParking`, `arrondissement`, `nombrePlaceVide`) VALUES
(1, 'test', '6', 'test', 'test', 6);
...
(17, '2022-06-09', '2023-02-02', '2023-04-04', 0, 0, 10, 'ABC'),
(18, '2022-06-09', '2023-02-02', '2023-04-04', 0, 0, 9, 'AB260931'),
(19, '2022-06-09', '2024-01-01', '2025-01-01', 0, 0, 9, 'AB260931'),
(20, '2022-06-09', '2024-01-01', '2025-01-01', 0, 0, 9, 'AB3100'),
(21, '2022-06-09', '2022-01-01', '2023-01-01', 0, 0, 10, 'AB3100');
...
('AB260931', 'Mercedes', 'Sport', 'Escence', 12003, '2021-05-01', 1, 500, 1),
('AB3100', 'Mercedes', 'sport', 'diesel', 120000, '2006-01-01', 1, 500, 1),
('ABC', 'jhsdfj', 'sdfsdfgd', 'sgdfgdg', 56454, '2022-06-07', 1, 100, 1);
...
--
ALTER TABLE `parking`
  MODIFY `codeParking` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `reservation`
--
ALTER TABLE `reservation`
  MODIFY `codeReservation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
